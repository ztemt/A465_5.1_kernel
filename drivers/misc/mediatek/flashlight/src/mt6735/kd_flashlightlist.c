...
extern int Flashlight2_Switch;
extern void Flashlight2_ON(void);
extern void Flashlight2_OFF(void);
static ssize_t show_Flashlight_Ctl(struct device *dev,struct device_attribute *attr, char *buf)
{
	return sprintf(buf, "%d\n", Flashlight_Switch);
}
static ssize_t show_Flashlight2_Ctl(struct device *dev2,struct device_attribute *attr2, char *buf2)
{
	return sprintf(buf2, "%d\n", Flashlight2_Switch);
}
...
static ssize_t store_Flashlight2_Ctl(struct device *dev,struct device_attribute *attr, const char *buf2, size_t size2)
{
...
static DEVICE_ATTR(Flashlight2_Ctl, 0664, show_Flashlight2_Ctl, store_Flashlight2_Ctl);
/************************************end****************************************************/
...
static int flashlight_probe(struct platform_device *dev)
{
	...
	int ret_device_file2 = 0;//aeon add for factory mode
	...
	ret_device_file2 = device_create_file(&(dev->dev), &dev_attr_Flashlight2_Ctl); //aeon add for factory mode
    /*initialize members*/
