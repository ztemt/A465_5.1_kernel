...
#define AF_DRVNAME "S5K4H5AF"
#define I2C_SLAVE_ADDRESS        0x18
#define I2C_REGISTER_ID            0x1a
#define PLATFORM_DRIVER_NAME "lens_actuator_S5K4H5AF"
#define AF_DRIVER_CLASS_NAME "actuatordrv_S5K4H5AF"
...
inline static int getAFInfo(__user stS5K4H5AF_MotorInfo * pstMotorInfo)
{
    stS5K4H5AF_MotorInfo stMotorInfo;
    ...
    if(copy_to_user(pstMotorInfo , &stMotorInfo , sizeof(stS5K4H5AF_MotorInfo)))
    {
...
#ifdef LensdrvCM3
inline static int getAFMETA(__user stS5K4H5AF_MotorMETAInfo * pstMotorMETAInfo)
{
    stS5K4H5AF_MotorMETAInfo stMotorMETAInfo;
    ...
    if(copy_to_user(pstMotorMETAInfo , &stMotorMETAInfo , sizeof(stS5K4H5AF_MotorMETAInfo)))
    {
        LOG_INF("copy to user failed when getting motor information \n");
    }
...
unsigned long a_u4Param)
{
    ...
    switch(a_u4Command)
    {
        case S5K4H5AFIOC_G_MOTORINFO :
            i4RetValue = getAFInfo((__user stS5K4H5AF_MotorInfo *)(a_u4Param));
        break;
        #ifdef LensdrvCM3
        case S5K4H5AFIOC_G_MOTORMETAINFO :
            i4RetValue = getAFMETA((__user stS5K4H5AF_MotorMETAInfo *)(a_u4Param));
        break;
        #endif
        case S5K4H5AFIOC_T_MOVETO :
            i4RetValue = moveAF(a_u4Param);
        break;

        case S5K4H5AFIOC_T_SETINFPOS :
            i4RetValue = setAFInf(a_u4Param);
        break;

        case S5K4H5AFIOC_T_SETMACROPOS :
...
static int __init S5K4H5AF_i2C_init(void)
{
...
static void __exit S5K4H5AF_i2C_exit(void)
{
    platform_driver_unregister(&g_stAF_Driver);
}

module_init(S5K4H5AF_i2C_init);
module_exit(S5K4H5AF_i2C_exit);

MODULE_DESCRIPTION("S5K4H5AF lens module driver");
